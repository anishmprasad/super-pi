...
#define PMIX_ASSEMBLY_FORMAT "default-.text-.globl-:-_-L--0-1-1-1-0"
...
/* User who built PMIx */
#define PMIX_CONFIGURE_USER "ghost"
...
#define PMIX_PACKAGE_STRING "PMIx ghost@Ghosts-MacBook-Pro.local Distribution"
